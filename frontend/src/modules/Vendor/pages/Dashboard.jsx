        ...
        <div className="bg-white rounded-xl p-4 sm:p-6 shadow-sm border border-gray-200">
          <div className="flex items-center justify-between mb-4 border-b border-gray-100 pb-3">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-0.5">Real-time statistics for your bulk business operations.</p>
            </div>
            <button
              onClick={() => navigate("/vendor/products")}
              className="text-xs font-semibold text-primary-600 hover:text-primary-700 bg-primary-50 px-2.5 py-1.5 rounded-lg transition-colors border border-primary-100"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div className="bg-gradient-to-br from-amber-50 to-amber-100/50 p-4 rounded-xl border border-amber-100">
              <p className="text-xs font-medium text-amber-800">Active B2B Products</p>
              <p className="text-2xl font-bold text-amber-900 mt-1">{b2bProducts.length}</p>
            </div>

            <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 p-4 rounded-xl border border-blue-100">
              <p className="text-xs font-medium text-blue-800">Wholesale Orders (Month)</p>

...
const B2BUsersDashboard = () => {
  const navigate = useNavigate();

  const menuItems = [
    {
      path: "/admin/b2b-users/manage",
      ...
      description: "View and manage all B2B users",
    },
    {
      path: "/admin/b2b-users/pending",
      ...
      description: "Review pending B2B user registrations",
    },
    {
      path: "/admin/b2b-users/analytics",
      label: "B2B Analytics",
      icon: FiBarChart2,
      ...
      description: "View B2B user performance analytics",
    },
  ];
    ...
    >
      ...
      <div className="px-1">
        ...
        <p className="text-sm sm:text-base text-gray-500">
          Manage B2B users, approvals, and analytics
        </p>
      </div>
...
export default B2BUsersDashboard;

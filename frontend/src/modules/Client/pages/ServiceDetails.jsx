      ...
      <div className="lg:col-span-5 space-y-6 text-center lg:text-left z-20 px-4">
        <AnimatePresence mode="wait">
          <motion.div
            ...
            className="space-y-5"
          >
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-client-primary/10 border border-client-primary/20">
               <span className="text-client-primary text-[10px] font-black uppercase tracking-widest">{activeItem.metric}</span>
            </div>
            ...
            <div className="pt-4 flex flex-wrap gap-4 justify-center lg:justify-start">
              <Link
                to="/get-quote"
                className="inline-flex items-center gap-2 px-6 py-3.5 bg-client-primary hover:bg-client-primary-hover text-black font-black text-xs uppercase tracking-wider rounded-xl transition-all shadow-md hover:shadow-lg hover:-translate-y-0.5"
              >
              ...
              {activeItem.appLink && (
                <a
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3.5 bg-app-card hover:bg-[#222] border border-app-border hover:border-client-primary/50 text-app-text font-black text-xs uppercase tracking-wider rounded-xl transition-all shadow-sm hover:shadow-md hover:-translate-y-0.5"
                >
                  <span>Visit App</span>
                  <ArrowRight className="w-4 h-4" />
                </a>
      ...
      <div className="lg:col-span-7 relative w-full h-[680px] flex items-center justify-center touch-pan-y">
        {items.map((port, idx) => {
          ...
          return (
            ...
            >
              <div className={`relative w-[280px] h-[560px] rounded-[3rem] border-[10px] shadow-2xl overflow-hidden transition-all duration-300 pointer-events-none ${position === 'center' ? 'border-[#222] bg-black ring-4 ring-client-primary/40' : 'border-[#444] bg-[#222] opacity-60'}`}>
                {/* Phone Notch */}
        ...
        <div className="absolute bottom-0 left-1/2 -translate-x-1/2 flex items-center gap-4 z-50 pointer-events-none">
          <button onClick={prev} className="pointer-events-auto w-10 h-10 rounded-full bg-app-card/80 backdrop-blur-sm border border-app-border flex items-center justify-center text-app-text hover:text-client-primary hover:border-client-primary/50 transition-all shadow-lg hover:scale-110 active:scale-95 cursor-pointer">
            <ArrowLeft className="w-4 h-4" />
          </button>
          <button onClick={next} className="pointer-events-auto w-10 h-10 rounded-full bg-app-card/80 backdrop-blur-sm border border-app-border flex items-center justify-center text-app-text hover:text-client-primary hover:border-client-primary/50 transition-all shadow-lg hover:scale-110 active:scale-95 cursor-pointer">
            <ArrowRight className="w-4 h-4" />
          </button>
        </div>
      </div>
...
export default function ServiceDetails() {
  ...
  const [billingCycle, setBillingCycle] = useState('client-primary'); // 'client-primary' (One-Time / Starter) or 'secondary' (Support / Quarterly)
  ...
  return (
    <div className="bg-app-bg text-app-text min-h-screen relative overflow-hidden font-sans selection:bg-client-primary/20 selection:text-client-primary">
      
      {/* Background Ambient Glows */}
      <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-client-primary/5 dark:bg-client-primary/5 rounded-full filter blur-[120px] -translate-y-1/3 translate-x-1/3 pointer-events-none z-0" />
      <div className="absolute top-[40%] left-[-15%] w-[450px] h-[450px] bg-client-primary/4 dark:bg-client-primary/2 rounded-full filter blur-[100px] pointer-events-none z-0" />
      ...
      <AnimatePresence mode="wait">
        {loading ? (
          ...
          >
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
              <div className="lg:col-span-7 space-y-4">
                <div className="h-6 w-24 bg-client-primary/10 border border-client-primary/20 rounded-full animate-pulse" />
          ...
          >
            ...
            <div className="relative border-b border-app-border/40 bg-gradient-to-b from-brand-lightOrange/20 to-transparent dark:from-client-primary/2 dark:to-transparent">
              <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-10 sm:pt-24 sm:pb-16">
                ...
                <div className="mb-6 sm:mb-12">
                  <nav className="flex items-center gap-2 text-[10px] sm:text-xs font-bold uppercase tracking-wider text-app-text-muted/60">
                    <Link to="/" className="hover:text-client-primary transition-colors">Home</Link>
                    <span>/</span>
                    <Link to="/services" className="hover:text-client-primary transition-colors">Services</Link>
                    <span>/</span>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
                  ...
                  >
                    <motion.div variants={fadeUp} className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-client-primary/10 border border-client-primary/20">
                      <div className="w-1.5 h-1.5 rounded-full bg-client-primary animate-pulse" />
                      <span className="text-client-primary text-[9px] font-black uppercase tracking-widest">{subtitle}</span>
                    </motion.div>
                    ...
                    <motion.div variants={fadeUp} className="pt-4 flex flex-col sm:flex-row items-stretch sm:items-center gap-3 sm:gap-4 w-full sm:w-auto">
                      <Link
                        to="/get-quote"
                        className="w-full sm:w-auto text-center px-6 py-3.5 sm:py-2.5 bg-client-primary hover:bg-client-primary-hover text-black font-black text-[11px] sm:text-xs uppercase tracking-wider rounded-xl hover:shadow-[0_0_25px_rgba(215,25,32,0.4)] transition-all duration-300 transform hover:-translate-y-0.5 cursor-pointer"
                      >
                        Get Free Quote
                      </Link>
                  ...
                  <div className="lg:col-span-5 hidden lg:block relative">
                    <div className="relative w-full aspect-[4/3] flex items-center justify-center group">
                      ...
                      <div className="absolute inset-0 flex items-center justify-center p-8 z-10">
                        <div className="relative w-48 h-48 rounded-full border border-client-primary/20 flex items-center justify-center bg-gradient-to-br from-client-primary/5 to-transparent shadow-inner group-hover:scale-105 transition-transform duration-700">
                          
                          {/* Inner glowing circle */}
                          <div className="absolute w-36 h-36 rounded-full border border-client-primary/10 bg-app-bg flex items-center justify-center shadow-lg">
                            {serviceMain.icon && (
                              <serviceMain.icon className="w-16 h-16 text-client-primary drop-shadow-[0_0_15px_rgba(215,25,32,0.35)] animate-float" />
                            )}
                          </div>

                          {/* Outer orbit lines & nodes */}
                          <div className="absolute w-48 h-48 rounded-full border-t border-client-primary/30 animate-spin" style={{ animationDuration: '10s' }} />
                          <div className="absolute w-2.5 h-2.5 rounded-full bg-client-primary top-0 left-1/2 -translate-x-1/2 shadow-[0_0_10px_#D71920]" />
                          <div className="absolute w-2 h-2 rounded-full bg-client-primary/50 bottom-4 right-8" />
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="bg-brand-lightOrange dark:bg-client-primary/5 border-y border-app-border py-6 sm:py-4 relative z-20">
              <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-4 items-start sm:items-center justify-between text-center md:text-left">
                  {highlights.map((hl, idx) => (
                    <div key={idx} className="flex flex-col sm:flex-row items-center gap-3 sm:gap-3 justify-center md:justify-start group p-3 sm:p-4 rounded-2xl hover:-translate-y-1 hover:bg-white/60 dark:hover:bg-[#1A1A2E]/80 hover:shadow-sm border border-transparent hover:border-client-primary/20 transition-all duration-300 cursor-default">
                      <div className="w-12 h-12 sm:w-10 sm:h-10 rounded-full bg-client-primary/10 border border-client-primary/20 flex items-center justify-center flex-shrink-0 text-client-primary group-hover:bg-client-primary group-hover:text-white group-hover:scale-110 transition-all duration-300 shadow-sm">
                      ...
                      <div className="space-y-1 sm:space-y-0.5 text-center sm:text-left px-2 sm:px-0">
                        <h4 className="text-[11px] sm:text-xs font-black text-app-text tracking-wide uppercase leading-snug group-hover:text-client-primary transition-colors duration-300">{hl.text}</h4>
            ...
            >
              <div className="max-w-3xl mx-auto px-4 text-center space-y-6">
                <div className="inline-flex items-center gap-1.5 justify-center">
                  <span className="h-0.5 w-6 bg-client-primary rounded-full" />
                  <h2 className="text-xs font-black uppercase text-client-primary tracking-[0.25em]">Service Overview</h2>
                  <span className="h-0.5 w-6 bg-client-primary rounded-full" />
                </div>
            ...
            <section className="py-10 sm:py-14 border-b border-app-border/40 bg-app-card/10">
              <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                  <h2 className="text-xs font-black uppercase text-client-primary tracking-[0.25em] mb-2">Our Capabilities</h2>
                  <h3 className="text-lg sm:text-xl md:text-2xl font-black text-app-text tracking-tight font-heading">
                  ...
                  {subServices.map((sub, idx) => {
                    ...
                    return (
                      <motion.div
                        ...
                        className="bg-white dark:bg-app-card border border-slate-100 dark:border-app-border rounded-2xl p-5 hover:border-client-primary/30 transition-all duration-300 shadow-sm dark:shadow-md hover:shadow-lg dark:hover:shadow-lg group flex flex-col h-full cursor-default"
                      >
                        <div className="w-10 h-10 rounded-xl bg-slate-50 dark:bg-app-bg border border-slate-100 dark:border-app-border flex items-center justify-center text-slate-500 dark:text-app-text-muted group-hover:text-client-primary group-hover:bg-client-primary/5 group-hover:border-client-primary/30 transition-all duration-300 mb-4 shadow-sm">
                          <IconComp className="w-5 h-5 transition-transform duration-300 group-hover:scale-110" />
                        </div>
                        
                        <h4 className="text-sm sm:text-base font-black text-app-text mb-2 group-hover:text-client-primary transition-colors">
                          {sub.title}
                        </h4>
            ...
            <section className="py-10 sm:py-14 border-b border-app-border/40 relative">
              <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                  <h2 className="text-xs font-black uppercase text-client-primary tracking-[0.25em] mb-2">Our Workflow</h2>
                  <h3 className="text-lg sm:text-xl md:text-2xl font-black text-app-text tracking-tight font-heading">
                  ...
                  >
                    {process.map((step, idx) => (
                      ...
                      >
                        ...
                        {/* Step Number Circle */}
                        <div className="w-14 h-14 shrink-0 rounded-full bg-app-bg border border-app-border flex items-center justify-center text-client-primary font-black text-sm shadow-sm group-hover:border-client-primary group-hover:shadow-md transition-all duration-300 relative z-10">
                          <span className="relative z-10">{step.step}</span>
                          <div className="absolute inset-0.5 rounded-full bg-client-primary/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                        </div>

                        {/* Title & Description */}
                        <div className="space-y-1.5 pt-2 lg:pt-0">
                          <h4 className="text-[13px] sm:text-sm font-black text-app-text uppercase tracking-wide group-hover:text-client-primary transition-colors">
                            {step.title}
                          </h4>
            ...
            <section className="py-10 sm:py-14 border-b border-app-border/40 bg-app-card/5">
              <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                  <h2 className="text-xs font-black uppercase text-client-primary tracking-[0.25em] mb-2">Pricing Models</h2>
                  <h3 className="text-lg sm:text-xl md:text-2xl font-black text-app-text tracking-tight font-heading">
                  ...
                  <div className="mt-8 inline-flex items-center p-1 rounded-xl bg-app-card border border-app-border">
                    <button
                      onClick={() => setBillingCycle('client-primary')}
                      className={`px-4 py-1.5 rounded-lg text-[10px] font-black uppercase tracking-wider transition-all duration-300 ${
                        billingCycle === 'client-primary' 
                          ? 'bg-client-primary text-black shadow-sm' 
                          : 'text-app-text-muted hover:text-app-text'
                      }`}
                    >
                      {pricing.toggleLabels.client-primary}
                    </button>
                    <button
                ...
                >
                  {pricing.plans.map((plan, idx) => {
                    const price = billingCycle === 'client-primary' ? plan.priceOneTime : plan.priceSupport;
                    ...
                    return (
                      <motion.div
                        ...
                        className={`group relative rounded-[2.25rem] bg-app-card flex flex-col justify-between p-5 md:p-6 pb-4 md:pb-5 text-center shadow-2xl transition-all duration-300 cursor-default ${
                          plan.highlight 
                            ? 'border border-client-primary/50 ring-1 ring-client-primary/20 shadow-[0_15px_35px_rgba(215,25,32,0.15)]' 
                      ...
                      >
                        ...
                        <div className="absolute inset-0 rounded-[2.25rem] overflow-hidden pointer-events-none z-0">
                          ...
                          {/* Ambient glow orbs */}
                          <div className="absolute top-10 left-10 w-32 h-32 bg-client-primary/5 rounded-full filter blur-xl pointer-events-none" />
                          {plan.highlight && (
                            <div className="absolute bottom-10 right-10 w-32 h-32 bg-client-primary/10 rounded-full filter blur-xl pointer-events-none" />
                          )}
                        </div>

                        {/* Float Badge for Growth Plan */}
                        {plan.highlight && (
                          <div className="absolute top-0 right-8 -translate-y-1/2 bg-client-primary text-black font-black uppercase text-[8px] tracking-widest px-4 py-1 rounded-full shadow-md z-10">
                            Most Popular
                          </div>
                        )}
                        ...
                        <div className="space-y-4 relative z-10">
                          ...
                          <div className="space-y-0.5">
                            <h4 className="text-lg sm:text-xl font-black text-app-text tracking-tight leading-tight uppercase font-heading group-hover:text-client-primary transition-colors duration-300">{plan.title}</h4>
                            ...
                            <ul className="space-y-2">
                              {plan.features.map((feature, fIdx) => (
                                <li key={fIdx} className="flex items-start gap-2">
                                  <div className="w-3.5 h-3.5 rounded-full bg-client-primary/10 border border-client-primary/20 flex items-center justify-center flex-shrink-0 text-app-text mt-0.5">
            ...
            <section className="py-10 sm:py-14 border-b border-app-border/40">
              <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <motion.div 
                  ...
                  className="text-center max-w-2xl mx-auto mb-12 sm:mb-16"
                >
                  <h2 className="text-xs font-black uppercase text-client-primary tracking-[0.25em] mb-2">Our Results</h2>
                  <h3 className="text-lg sm:text-xl md:text-2xl font-black text-app-text tracking-tight font-heading">
                    ...
                    {portfolio.map((port, idx) => (
                      ...
                      >
                        ...
                        <div className="p-5 space-y-3 z-10 relative bg-app-card">
                          <div className="inline-block bg-client-primary/10 border border-client-primary/20 rounded-md px-2.5 py-0.5">
                            <span className="text-client-primary text-[10px] font-black uppercase tracking-wider">{port.metric}</span>
                          </div>
                          
                          <h4 className="text-sm sm:text-base font-black text-app-text group-hover:text-client-primary transition-colors">
                            {port.title}
                          </h4>
            ...
            <section className="py-10 sm:py-14 border-b border-app-border/40 bg-app-card/10">
              <div className="max-w-4xl mx-auto px-4">
                ...
                >
                  <h2 className="text-xs font-black uppercase text-client-primary tracking-[0.25em] mb-2">Answering Queries</h2>
                  <h3 className="text-lg sm:text-xl md:text-2xl font-black text-app-text tracking-tight font-heading">
                    ...
                    return (
                      <motion.div 
                        ...
                        className={`bg-app-card border rounded-2xl overflow-hidden transition-all duration-300 ${
                          isOpen ? 'border-client-primary/45 shadow-sm' : 'border-app-border'
                        }`}
                      >
                        {/* Question Header */}
                        <button
                          onClick={() => setActiveFaq(isOpen ? null : idx)}
                          className="w-full py-4 px-5 text-left flex items-center justify-between gap-4 font-bold text-xs sm:text-sm text-app-text hover:text-client-primary transition-colors"
                        >
                          <span className="font-black leading-snug">{faq.q}</span>
                          <ChevronDown className={`w-4 h-4 text-app-text-muted/65 transition-transform duration-300 ${isOpen ? 'rotate-180 text-client-primary' : ''}`} />
                        </button>
            ...
            <section className="py-10 sm:py-14 border-b border-app-border/40">
              <div className="max-w-4xl mx-auto px-4">
                ...
                <motion.div 
                  ...
                  className="bg-brand-lightOrange dark:bg-client-primary/5 border border-app-border rounded-3xl p-6 sm:p-10 relative overflow-hidden flex flex-col md:flex-row items-center gap-6 sm:gap-8 shadow-sm hover:shadow-xl hover:shadow-client-primary/5 hover:border-client-primary/30 transition-all duration-300 cursor-default group"
                >
                  ...
                  >
                    <Quote className="w-16 h-16 text-client-primary" />
                  </motion.div>
                  ...
                  <motion.div 
                    ...
                    className="w-20 h-20 sm:w-24 sm:h-24 rounded-2xl overflow-hidden border border-app-border flex-shrink-0 bg-app-bg shadow-sm relative group-hover:border-client-primary/40 transition-colors duration-300"
                  >
                    <img 
                    ...
                    />
                    <div className="absolute inset-0 bg-gradient-to-t from-client-primary/10 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  </motion.div>
                  ...
                  <div className="space-y-4 text-center md:text-left flex-grow relative z-10">
                    ...
                    >
                      {[1,2,3,4,5].map((star) => (
                        ...
                        >
                          <Star className="w-3.5 h-3.5 fill-client-primary text-client-primary drop-shadow-[0_0_4px_rgba(215,25,32,0.3)]" />
                        </motion.div>
                      ))}
                    </motion.div>
                    ...
                    >
                      <h4 className="text-xs sm:text-sm font-black text-app-text uppercase tracking-wide group-hover:text-client-primary transition-colors duration-300">
                        {testimonial.author}
                      </h4>
              ...
              <div className="max-w-5xl mx-auto">
                ...
                >
                  ...
                  <div className="absolute inset-0 opacity-20 pointer-events-none overflow-hidden z-0">
                    ...
                    <div className="absolute -top-1/2 left-2/3 w-[220px] h-[200%] bg-gradient-to-b from-client-primary/10 via-client-primary/5 to-transparent rotate-[25deg] blur-3xl" />
                  </div>

                  {/* Glow Horizon Arc at Bottom */}
                  <div className="absolute -bottom-24 left-1/2 -translate-x-1/2 w-[160%] aspect-[4/1] rounded-[100%] border-t-2 border-client-primary bg-gradient-to-b from-client-primary/25 via-client-primary/5 to-transparent blur-[3px] opacity-80 pointer-events-none z-0" />
                  ...
                  <div className="relative z-10 max-w-2xl mx-auto space-y-6 sm:space-y-8">
                    ...
                    <h3 className="text-xl sm:text-2xl md:text-3xl font-black font-heading text-app-text tracking-tight leading-tight">
                      Ready to Grow Your <span className="text-client-primary">Business Operations?</span>
                    </h3>
                    ...
                    <div className="pt-2 flex flex-col sm:flex-row gap-4 items-center justify-center">
                      <Link
                        to="/get-quote"
                        className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3 bg-client-primary hover:bg-client-primary-hover text-black font-black text-xs uppercase tracking-wider rounded-xl shadow-lg shadow-client-primary/25 hover:shadow-client-primary/45 transition-all duration-300 transform hover:-translate-y-0.5 cursor-pointer"
                      >
                      ...
                      <Link
                        to="/portfolio"
                        className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-8 py-3 bg-app-card hover:bg-app-border/50 text-app-text border border-app-border hover:border-client-primary/30 font-black text-xs uppercase tracking-wider rounded-xl transition-all duration-300 transform hover:-translate-y-0.5 cursor-pointer"
                      >
            ...
            <AnimatePresence>
              {showStickyCta && (
                ...
                >
                  ...
                  <Link
                    to="/get-quote"
                    className="w-full xs:w-auto px-4 py-2 bg-client-primary hover:bg-client-primary-hover text-black font-black text-[10px] uppercase tracking-wider rounded-xl transition-all duration-300 text-center flex items-center justify-center gap-1 cursor-pointer"
                  >
                    <span>Get Quote</span>

  ...
  return (
    <div className="min-h-screen bg-app-bg pt-24 pb-24">
      ...
      <section className="relative overflow-hidden mb-16">
        <div className="absolute inset-0 bg-gradient-to-br from-client-primary/10 via-app-bg to-app-bg z-0" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 pt-16 pb-12 lg:pt-24 lg:pb-20">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center space-x-2 bg-client-primary/10 text-client-primary px-4 py-2 rounded-full mb-6">
                <ShieldCheck size={20} />
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-black font-heading text-app-text leading-tight mb-6">
                Data Processing <span className="text-client-primary">Agreement</span>
              </h1>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="mailto:support@ple.in" className="btn-client-primary flex justify-center text-center">
      ...
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <div className="space-y-4">
            {dpaSections.map((section, index) => (
              ...
              >
                ...
                >
                  <span className={`font-bold font-heading text-lg ${openSection === index ? 'text-client-primary' : 'text-app-text'}`}>
                    {section.title}
                  </span>
                  <motion.div
                    animate={{ rotate: openSection === index ? 180 : 0 }}
                    transition={{ duration: 0.3 }}
                    className={`flex-shrink-0 ml-4 ${openSection === index ? 'text-client-primary' : 'text-slate-400'}`}
                  >
                    <ChevronDown size={24} />
                  </motion.div>
                </button>
          ...
          <div className="mt-12 p-6 bg-client-primary/10 rounded-2xl border border-client-primary/20">
            ...
            <p className="font-semibold text-client-primary">

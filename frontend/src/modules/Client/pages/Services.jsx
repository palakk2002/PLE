  ...
  return (
    <div className="bg-app-bg text-app-text-muted min-h-screen py-16 sm:py-24 px-4 sm:px-6 lg:px-8 mesh-grid relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between max-w-6xl mx-auto mb-16 sm:mb-24 gap-10 md:gap-16 relative">
          ...
          >
            <div className="mb-4 sm:mb-6">
              <motion.span variants={scrollFadeUp} className="inline-block text-client-primary text-[10px] sm:text-xs font-semibold uppercase tracking-[0.2em] bg-client-primary/10 border border-client-primary/20 px-4 py-1.5 rounded-full">
                Our Capabilities
              </motion.span>
            </div>
            <motion.h1 variants={scrollFadeUp} className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-medium font-heading text-app-text mb-6 leading-tight">
              High Performance Solutions at <span className="text-client-primary text-gradient-orange font-semibold">Economical Prices</span>
            </motion.h1>
          ...
          >
            ...
            <div className="absolute top-[45%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 md:w-80 md:h-80 bg-gradient-to-tr from-client-primary/30 to-client-primary/5 rounded-full blur-xl pointer-events-none" />
            <div className="absolute top-[45%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-56 h-56 md:w-72 md:h-72 border border-client-primary/20 rounded-full pointer-events-none" />
            <div className="absolute top-[45%] left-1/2 -translate-x-1/2 -translate-y-1/2 w-[140%] h-[140%] bg-client-primary/10 blur-[100px] rounded-full pointer-events-none" />
            ...
            <div className="absolute bottom-4 left-1/2 -translate-x-1/2 w-3/4 h-6 bg-client-primary/30 blur-2xl rounded-[50%] pointer-events-none z-0" />
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 w-2/3 h-[2px] bg-gradient-to-r from-transparent via-client-primary/80 to-transparent opacity-70 pointer-events-none z-20" />
        ...
        >
          <div className="absolute -top-10 -left-10 w-40 h-40 bg-client-primary/10 rounded-full filter blur-3xl pointer-events-none" />
          <div className="absolute -bottom-10 -right-10 w-40 h-40 bg-client-primary/10 rounded-full filter blur-3xl pointer-events-none" />
          ...
          <div className="max-w-2xl mx-auto space-y-4 sm:space-y-5 relative z-10">
            ...
            <div className="pt-2">
              <Link
                to="/get-quote"
                className="px-6 py-2.5 bg-client-primary hover:bg-client-primary-hover text-black font-bold text-xs uppercase tracking-wider rounded-xl hover:shadow-[0_0_30px_rgba(215,25,32,0.5)] transition-all duration-300 inline-block cursor-pointer transform hover:-translate-y-1"
              >

    ...
    <div className="mb-4 overflow-hidden rounded-xl border border-app-border bg-app-card shadow-sm transition-all duration-300">
      <button
        className={`w-full px-6 py-4 text-left flex justify-between items-center transition-colors duration-300 ${
          isOpen ? 'bg-client-primary text-black' : 'bg-app-card text-app-text hover:bg-slate-50 dark:hover:bg-slate-800/50'
        }`}
        onClick={onClick}
      >
...
export default function FAQ() {
  ...
  return (
    <div className="min-h-screen bg-app-bg pt-20">
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center gap-12 lg:gap-24">
          <div className="flex-1 text-center lg:text-left">
            ...
            >
              ...
              <span>/</span>
              <span className="text-client-primary">FAQs</span>
            </motion.div>
            <motion.h1 
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              How can we <br className="hidden lg:block" /><span className="text-client-primary">help you?</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
          ...
          <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 items-start">
            <div className="lg:w-1/3">
              ...
              >
                <Link 
                  to="/get-quote" 
                  className="inline-flex items-center gap-2 px-8 py-3.5 bg-slate-900 dark:bg-client-primary text-white dark:text-black font-bold rounded-full hover:bg-slate-800 dark:hover:bg-client-primary-hover transition-all duration-300 group shadow-lg"
                >
                  Contact Us
      ...
      <section className="py-24 bg-client-primary/5 dark:bg-client-primary/10 relative overflow-hidden">
        {/* Decorative background shapes */}
        <div className="absolute top-0 right-0 w-96 h-96 bg-client-primary/10 rounded-full blur-3xl -mr-48 -mt-48"></div>
            ...
            <div className="lg:w-5/12">
              ...
              >
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-client-primary/10 flex items-center justify-center flex-shrink-0">
                    <MapPin className="w-5 h-5 text-client-primary" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-client-primary/10 flex items-center justify-center flex-shrink-0">
                    <Mail className="w-5 h-5 text-client-primary" />
                  </div>
                  <div>
                ...
                <div className="flex items-start gap-4">
                  <div className="w-10 h-10 rounded-full bg-client-primary/10 flex items-center justify-center flex-shrink-0">
                    <Phone className="w-5 h-5 text-client-primary" />
                  </div>
                  <div>
                ...
                <form className="space-y-6 relative z-10" onSubmit={(e) => e.preventDefault()}>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                    <div>
                      <input 
                        ...
                        className="w-full bg-white dark:bg-slate-900 px-5 py-4 rounded-xl text-slate-800 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-client-primary transition-all border border-transparent dark:border-slate-800"
                        required
                      />
                    </div>
                    <div>
                  ...
                  <div>
                    <textarea 
                      placeholder="Message" 
                      rows="4"
                      className="w-full bg-white dark:bg-slate-900 px-5 py-4 rounded-xl text-slate-800 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-client-primary transition-all resize-none border border-transparent dark:border-slate-800"
                      required
                    ></textarea>
                  </div>
                  ...
                  <div className="flex justify-end">
                    <button 
                      type="submit"
                      className="px-8 py-3.5 bg-client-primary text-black font-bold rounded-xl hover:bg-client-primary-hover hover:shadow-[0_0_20px_rgba(215,25,32,0.4)] transition-all duration-300"
                    >
                      Send Message
                    </button>
                  </div>

        ...
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 relative">
          ...
          >
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-lg font-bold text-app-text mb-2 flex items-center gap-2">
                    <span className="w-2 h-2 rounded-full bg-client-primary"></span>
              ...
              <ul className="space-y-3">
                {[
                  ...
                  <li key={index} className="flex items-start">
                    <span className="text-client-primary mr-3 mt-1">•</span>
                    <span>{item}</span>
                  </li>
                ))}
              </ul>
            ...
            <section>
              ...
              <div className="mt-6 p-6 bg-client-primary/5 dark:bg-client-primary/10 rounded-2xl border border-client-primary/10 dark:border-client-primary/20 flex items-start gap-4">

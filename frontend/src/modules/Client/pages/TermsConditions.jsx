            ...
            <section>
              ...
              <div className="space-y-6">
                <div className="bg-white dark:bg-app-card p-6 rounded-2xl border border-slate-100 dark:border-app-border shadow-sm">
                  <h3 className="font-bold text-app-text mb-2 text-client-primary">Ownership of Work</h3>
                ...
                <div className="bg-white dark:bg-app-card p-6 rounded-2xl border border-slate-100 dark:border-app-border shadow-sm">
                  <h3 className="font-bold text-app-text mb-2 text-client-primary">Trademarks and Branding</h3>
                ...
                <div className="bg-white dark:bg-app-card p-6 rounded-2xl border border-slate-100 dark:border-app-border shadow-sm">
                  <h3 className="font-bold text-app-text mb-2 text-client-primary">Client Data</h3>

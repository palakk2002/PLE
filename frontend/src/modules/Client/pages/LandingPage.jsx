    ...
    <div className="w-full relative">
      ...
      <section className="relative pt-16 pb-12 px-4 md:px-8 text-center max-w-5xl mx-auto">
        ...
        <motion.div 
          ...
          className="space-y-6"
        >
          <div className="inline-block px-4 py-1.5 rounded-full bg-client-primary/10 text-client-primary text-xs font-bold tracking-widest uppercase mb-4">
          ...
          <div className="pt-8">
            <button 
              ...
              className="px-8 py-4 bg-client-primary hover:bg-client-primary-hover text-black font-extrabold text-sm uppercase tracking-widest rounded-full transition-all shadow-xl hover:-translate-y-1 flex items-center gap-2 mx-auto"
            >
      ...
      <section className="py-8 border-y border-app-border bg-app-card/50">
        <div className="max-w-6xl mx-auto px-4 flex flex-wrap justify-center gap-8 md:gap-16 opacity-70">
          <div className="flex items-center gap-2 text-sm font-bold text-app-text">
            <Users className="w-5 h-5 text-client-primary" /> 50+ Enterprise Clients
          </div>
          <div className="flex items-center gap-2 text-sm font-bold text-app-text">
            <Award className="w-5 h-5 text-client-primary" /> Google & Meta Partner
          </div>
          <div className="flex items-center gap-2 text-sm font-bold text-app-text">
            <TrendingUp className="w-5 h-5 text-client-primary" /> 100% ROI Focused
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 max-w-5xl mx-auto">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <motion.div 
            ...
            whileInView={{ opacity: 1, x: 0 }}
            viewport={{ once: true }}
            className="space-y-4 glass-panel p-8 rounded-3xl border border-client-primary/20 relative overflow-hidden"
          >
            <div className="absolute inset-0 bg-client-primary/5" />
            <div className="relative">
              <div className="w-12 h-12 rounded-full bg-client-primary/10 flex items-center justify-center text-client-primary mb-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {pageData.highlights.map((highlight, idx) => (
              <motion.div 
                ...
                className="bg-app-bg p-8 rounded-2xl border border-app-border hover:border-client-primary/50 transition-colors"
              >
                <div className="w-10 h-10 rounded-full bg-client-primary/10 text-client-primary flex items-center justify-center mb-4">
      ...
      <section className="py-20 px-4 max-w-5xl mx-auto text-center">
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {['Starter', 'Growth', 'Enterprise'].map((tier, idx) => (
            <div key={idx} className={`p-8 rounded-2xl border ${idx === 1 ? 'border-client-primary bg-client-primary/5 relative' : 'border-app-border bg-app-card'}`}>
              {idx === 1 && (
                <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-client-primary text-black text-[10px] font-black uppercase tracking-widest px-3 py-1 rounded-full">
                  Most Popular
                </div>
              )}
              ...
              <button 
                onClick={() => document.getElementById('lp-form').scrollIntoView({ behavior: 'smooth' })}
                className={`w-full py-2 rounded-full text-xs font-bold uppercase tracking-widest transition-colors ${idx === 1 ? 'bg-client-primary text-black hover:bg-client-primary-hover' : 'bg-app-bg text-app-text border border-app-border hover:border-client-primary/50'}`}
              >
                Get Quote
              </button>
            </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-8">
            <div className="p-8 rounded-2xl bg-app-bg border border-app-border relative">
              <div className="flex gap-1 text-client-primary mb-4">
              ...
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-client-primary/20" />
                <div>
      ...
      <section id="lp-form" className="py-24 px-4 max-w-3xl mx-auto relative">
        <div className="absolute inset-0 bg-client-primary/5 filter blur-[100px] rounded-full -z-10" />
        <div className="glass-panel p-8 md:p-12 rounded-3xl border border-client-primary/20 text-center">
          ...
          {isSubmitSuccess ? (
            ...
            >
              <div className="w-16 h-16 rounded-full bg-client-primary/10 text-client-primary flex items-center justify-center">
            ...
            <form onSubmit={handleSubmit(onSubmitForm)} className="space-y-6 text-left">
              <div className="grid md:grid-cols-2 gap-6">
                <div className="space-y-1.5 relative group">
                  ...
                  <div className="relative">
                    <User className="absolute left-0 top-1/2 -translate-y-1/2 w-4 h-4 text-app-text-muted/50 group-focus-within:text-client-primary transition-colors" />
                    <input 
                      type="text" 
                      placeholder="e.g. Rahul Sharma"
                      className="w-full bg-transparent border-b-2 py-2 pl-7 text-app-text focus:outline-none focus:border-client-primary transition-colors text-sm font-bold placeholder:text-app-text-muted/20 border-app-border/70"
                ...
                <div className="space-y-1.5 relative group">
                  ...
                  <div className="relative">
                    <Phone className="absolute left-0 top-1/2 -translate-y-1/2 w-4 h-4 text-app-text-muted/50 group-focus-within:text-client-primary transition-colors" />
                    <input 
                      type="tel" 
              ...
              <div className="space-y-1.5 relative group">
                ...
                <div className="relative">
                  <Mail className="absolute left-0 top-1/2 -translate-y-1/2 w-4 h-4 text-app-text-muted/50 group-focus-within:text-client-primary transition-colors" />
                  <input 
                    type="email" 
              ...
              <div className="space-y-1.5 relative group">
                ...
                <div className="relative">
                  <Briefcase className="absolute left-0 top-1/2 -translate-y-1/2 w-4 h-4 text-app-text-muted/50 group-focus-within:text-client-primary transition-colors" />
                  <input 
                    type="text" 
              ...
              <div className="space-y-1.5 relative group">
                ...
                <div className="relative">
                  <FileText className="absolute left-0 top-3 w-4 h-4 text-app-text-muted/50 group-focus-within:text-client-primary transition-colors" />
                  <textarea 
                    rows="2"
                    placeholder="Briefly explain what you're looking for..."
                    className="w-full bg-transparent border-b-2 py-2 pl-7 text-app-text focus:outline-none focus:border-client-primary transition-all resize-none text-sm font-bold placeholder:text-app-text-muted/20 border-app-border/70"
                    {...register('message')}
                  />
                </div>
              </div>

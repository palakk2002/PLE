  ...
  if (!post) {
    return (
      <div className="min-h-screen bg-app-bg text-app-text flex flex-col items-center justify-center mesh-grid">
        ...
        <Link to="/blog" className="text-client-primary hover:underline flex items-center gap-2">
  ...
  return (
    <div className="min-h-screen bg-app-bg text-app-text-muted pt-28 pb-20 mesh-grid relative overflow-hidden">
      <div className="max-w-4xl mx-auto px-4 relative z-10">
        {/* Back Button */}
        <Link to="/blog" className="text-app-text-muted hover:text-client-primary flex items-center gap-2 mb-8 transition-colors duration-300 w-fit">
          <ArrowLeft size={16} /> Back to Blog
        </Link>
        ...
        >
          ...
          <div className="flex flex-wrap items-center gap-6 text-app-text-muted text-sm mb-10 pb-6 border-b border-app-border/40">
            <div className="flex items-center gap-2">
              <User size={14} className="text-client-primary" />
              <span>By PLE Team</span>
            </div>
            <div className="flex items-center gap-2">
              <Calendar size={14} className="text-client-primary" />
              <span>May 16, 2026</span>
            </div>
            <div className="flex items-center gap-2">
              <Tag size={14} className="text-client-primary" />

...
export default function About() {
  ...
  return (
    <div className="bg-app-bg text-app-text-muted min-h-screen pt-24 pb-8 sm:pb-12 px-4 sm:px-6 lg:px-8 mesh-grid relative overflow-hidden">
      ...
      <div className="absolute top-10 left-1/3 w-3 h-3 bg-client-primary/30 rounded-full filter blur-sm animate-bounce" style={{ animationDuration: '6s' }} />
      <div className="absolute bottom-20 right-1/3 w-4 h-4 bg-client-primary/25 rounded-full filter blur-md animate-ping" style={{ animationDuration: '9s' }} />
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-center mb-28">
          ...
          >
            ...
            <motion.div variants={scrollFadeUp} className="flex items-center gap-2">
              ...
              <span className="text-xs font-extrabold text-client-primary uppercase tracking-widest">
                About PLE
              </span>
            </motion.div>
            ...
            <h1 className="text-4xl md:text-5xl font-black font-heading text-app-text leading-tight tracking-tight flex flex-col gap-1.5">
              <EncryptedText 
                ...
                encryptedClassName="text-client-primary/60 font-mono"
                revealDelayMs={30}
              />
              <EncryptedText 
            ...
            >
              {[
                ...
                <div key={idx} className="flex items-center gap-2.5 text-xs text-app-text font-medium">
                  <div className="w-5 h-5 rounded-full bg-client-primary/10 border border-client-primary/20 flex items-center justify-center text-client-primary shrink-0">
          ...
          >
            ...
            <div className="relative w-full max-w-[280px] sm:max-w-[360px] lg:max-w-[420px] aspect-square">
              ...
              <div className="absolute -top-4 -left-4 -bottom-4 -right-4 sm:-top-6 sm:-left-6 sm:-bottom-6 sm:-right-6 border-[2px] sm:border-[3px] border-dashed border-client-primary/30 rounded-full pointer-events-none animate-spin" style={{ animationDuration: '40s' }} />

              {/* Glowing Accent Orb underneath circle */}
              <div className="absolute inset-0 rounded-full bg-client-primary/20 filter blur-xl sm:blur-2xl animate-pulse pointer-events-none" />

              {/* Large Circle image mask with robust orange stroke */}
              <motion.div 
                variants={imageReveal}
                className="relative w-full h-full rounded-full border-[6px] sm:border-[10px] border-client-primary overflow-hidden shadow-[0_20px_50px_rgba(215,25,32,0.25)] group transition-transform duration-500 hover:scale-[1.02] z-10"
              >
                <img
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-client-primary/20 via-transparent to-transparent pointer-events-none mix-blend-multiply" />
              </motion.div>
              ...
              <motion.div 
                ...
                className="absolute top-4 -left-8 sm:top-10 sm:-left-12 bg-app-card backdrop-blur-md border border-app-border rounded-2xl p-3 sm:p-4 shadow-xl flex items-center gap-2 sm:gap-3 orange-glow-sm hover:border-client-primary/40 transition-colors z-20"
              >
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-client-primary/10 flex items-center justify-center text-client-primary font-black text-xs sm:text-sm">
                  {content?.hero?.secureStatValue || '99%'}
                </div>
                <div className="text-left">
                  <p className="text-[9px] sm:text-[10px] font-extrabold text-client-primary uppercase tracking-wider">{content?.hero?.secureStatLabel1 || 'Secure'}</p>
              ...
              <motion.div 
                ...
                className="absolute bottom-4 -right-8 sm:bottom-10 sm:-right-12 bg-app-card backdrop-blur-md border border-app-border rounded-2xl p-3 sm:p-4 shadow-xl flex items-center gap-2 sm:gap-3 orange-glow-sm hover:border-client-primary/40 transition-colors z-20"
              >
                <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-client-primary/10 flex items-center justify-center text-client-primary font-black text-xs sm:text-sm">
                  {content?.hero?.categoryStatValue || '25+'}
                </div>
                <div className="text-left">
                  <p className="text-[9px] sm:text-[10px] font-extrabold text-client-primary uppercase tracking-wider">{content?.hero?.categoryStatLabel1 || 'Product'}</p>
          ...
          <div className="order-2 lg:col-span-6 lg:col-start-1 lg:row-start-1 lg:row-span-2 relative flex items-center justify-center min-h-[400px] sm:min-h-[480px] w-full self-center">
            ...
            >
              <defs>
                ...
                <pattern id="halftonePattern" x="0" y="0" width="16" height="16" patternUnits="userSpaceOnUse">
                  <circle cx="2" cy="2" r="1.5" className="fill-client-primary/20 dark:fill-client-primary/10" />
                </pattern>
            ...
            <div className="relative w-full max-w-[420px] aspect-square flex items-center justify-center z-10">
              ...
              >
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-client-primary/10 via-transparent to-transparent pointer-events-none" />
              </motion.div>
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-15">
                <motion.div
                  ...
                  viewport={{ once: true }}
                  className="glass-panel bg-app-card backdrop-blur-xl border border-app-border rounded-2xl p-6 shadow-[0_20px_50px_rgba(215,25,32,0.22)] flex flex-col items-center justify-center text-center w-36 h-36 orange-glow-sm hover:border-client-primary/50 transition-colors duration-300"
                >
                  <div className="text-3xl md:text-4xl font-black text-client-primary font-heading leading-none">{content?.aboutCompany?.yearsOfExcellence || '5+'}</div>
            ...
            >
              ...
              {!content?.aboutCompany?.paragraphs && (
                <>
                  ...
                  <p>
                    We are a <strong className="text-client-primary font-bold">next-generation shopping marketplace</strong> helping customers discover quality products, compare better deals, and buy from trusted sellers with secure checkout.
                  </p>
                  <p>
              ...
              {content?.aboutCompany?.features?.map((feature, i) => {
                ...
                return (
                  <div key={i} className="flex items-start gap-3 group hover:-translate-y-1 transition-all duration-300 cursor-default">
                    <div className="w-9 h-9 rounded-lg bg-client-primary/10 border border-client-primary/15 text-client-primary flex items-center justify-center shrink-0 orange-glow-sm group-hover:bg-client-primary group-hover:text-white group-hover:scale-110 transition-all duration-300">
                      <Icon className="w-4.5 h-4.5 stroke-[2.5]" />
                    </div>
                    <div className="space-y-0.5">
                      <h4 className="text-xs md:text-sm font-extrabold text-app-text font-heading group-hover:text-client-primary transition-colors duration-300">{feature.title}</h4>
        ...
        <div className="mb-16 md:mb-28 text-left space-y-12">
          ...
          >
            <span className="text-[10px] font-extrabold text-client-primary uppercase tracking-widest bg-client-primary/10 px-2.5 py-1 rounded-md">
              What We Do
            </span>
            ...
            {(content?.whatWeDo?.services || []).map((service, idx) => {
              ...
              return (
                <motion.div 
                  key={idx} 
                  variants={scrollFadeUp}
                  className="glass-panel rounded-2xl p-6 bg-app-card border border-app-border shadow-md hover:shadow-xl hover:border-client-primary/30 hover:-translate-y-1.5 transition-all duration-300 group relative overflow-hidden flex flex-col justify-between min-h-[220px]"
                >
                  {/* Subtle orb background on hover */}
                  <div className="absolute -bottom-10 -right-10 w-24 h-24 bg-client-primary/3 rounded-full filter blur-xl group-hover:bg-client-primary/6 transition-colors" />
                  
                  <div className="space-y-4">
                    <div className="w-11 h-11 rounded-xl bg-client-primary/10 border border-client-primary/15 text-client-primary flex items-center justify-center orange-glow-sm group-hover:bg-client-primary group-hover:text-black transition-all duration-300">
                      <ServiceIcon className="w-5.5 h-5.5" />
                    </div>
                    <div className="space-y-1.5">
                      <h3 className="text-sm md:text-base font-extrabold text-app-text font-heading group-hover:text-client-primary transition-colors duration-200">
                        {service.title}
                      </h3>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mb-16 md:mb-28">
          ...
          <motion.div
            ...
            viewport={{ once: true, margin: '-100px' }}
            variants={scrollFadeLeft}
            className="glass-panel rounded-3xl p-6 md:p-10 text-left bg-app-card border border-app-border relative overflow-visible group hover:border-client-primary/30 transition-all duration-300 hover:shadow-[0_15px_30px_rgba(215,25,32,0.06)]"
          >
            {/* Masked internal container for blur circle */}
            <div className="absolute inset-0 overflow-hidden rounded-3xl pointer-events-none">
              <div className="absolute -top-10 -right-10 w-28 h-28 bg-client-primary/5 rounded-full filter blur-2xl group-hover:bg-client-primary/10 transition-colors" />
            </div>

            {/* Premium Corner Brackets matching website branding theme (diagonal top-right and bottom-left layout) */}
            <div className="absolute -top-1.5 -right-1.5 w-8 h-8 md:w-12 md:h-12 border-t-[4px] border-r-[4px] border-client-primary rounded-tr-3xl pointer-events-none transition-transform duration-300 group-hover:translate-x-1 group-hover:-translate-y-1 group-hover:scale-105" />
            <div className="absolute -bottom-1.5 -left-1.5 w-8 h-8 md:w-12 md:h-12 border-b-[4px] border-l-[4px] border-client-primary rounded-bl-3xl pointer-events-none transition-transform duration-300 group-hover:-translate-x-1 group-hover:translate-y-1 group-hover:scale-105" />
            ...
            {(content?.ourEdge?.steps || [
              ...
              return (
                <motion.div 
                  key={bidx} 
                  variants={scrollFadeUp}
                  className={`relative glass-panel bg-app-card backdrop-blur-md border border-app-border rounded-2xl p-4 md:p-5 shadow-lg hover:border-client-primary/30 transition-all duration-300 hover:shadow-2xl hover:z-50 w-full max-w-[480px] ${mlClass} ${zIndexClass} group`}
                  style={{ 
                ...
                >
                  <div className="flex items-start justify-between gap-4">
                    <div className="space-y-1 text-left">
                      <h4 className="text-xs md:text-sm font-extrabold text-app-text font-heading flex items-center gap-2 group-hover:text-client-primary transition-colors">
                        <span className="w-1.5 h-1.5 rounded-full bg-client-primary" />
                        <span>{box.title}</span>
                      </h4>
                    ...
                    {/* Step tag watermark */}
                    <div className="text-2xl font-black font-heading text-client-primary/10 select-none group-hover:text-client-primary/25 group-hover:scale-105 transition-all duration-300">
                      {box.step}
                    </div>
                  </div>
                </motion.div>

...
const ALL_PRICING_PLANS = [
  ...
  // Branding & UI/UX
  {
    ...
    features: [
      ...
      'client-primary & secondary color palette selection',
...
export default function Pricing() {
  ...
  return (
    <div className="min-h-screen bg-app-bg text-app-text relative pt-36 pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      {/* Decorative Orbs */}
      <div className="absolute top-1/4 -left-20 w-96 h-96 bg-client-primary/5 rounded-full filter blur-[150px] pointer-events-none z-0" />
      <div className="absolute bottom-1/4 -right-20 w-96 h-96 bg-client-primary/4 rounded-full filter blur-[150px] pointer-events-none z-0" />
      ...
      <div className="max-w-6xl mx-auto relative z-10 space-y-16">
        ...
        <div className="text-center space-y-4 max-w-3xl mx-auto">
          <motion.span 
            ...
            className="inline-flex items-center text-client-primary text-[10px] font-black uppercase tracking-widest bg-client-primary/10 border border-client-primary/20 px-3 py-1 rounded-full"
          >
          ...
          >
            All Services <span className="text-client-primary text-gradient-orange">Pricing</span>
          </motion.h1>
            ...
            <button
              ...
              className={`px-4 sm:px-5 py-2 rounded-full text-[11px] sm:text-xs font-bold tracking-wider transition-all duration-300 cursor-pointer whitespace-nowrap shrink-0 snap-center ${
                activeCategory === category.id
                  ? 'bg-client-primary text-black shadow-[0_0_20px_rgba(215,25,32,0.4)]'
        ...
        <motion.div 
          ...
          className="relative overflow-hidden rounded-[2.5rem] bg-client-primary dark:bg-app-card border border-black/10 dark:border-white/10 px-6 py-10 md:py-14 text-center shadow-2xl max-w-5xl mx-auto"
        >
          ...
          <div className="absolute top-1/2 left-1/4 -translate-y-1/2 -translate-x-1/2 w-80 h-80 bg-client-primary/10 rounded-full filter blur-[120px] pointer-events-none z-0" />

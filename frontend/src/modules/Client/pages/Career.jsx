...
export default function Career() {
  ...
  return (
    <div className="min-h-screen bg-app-bg text-app-text relative pt-24 sm:pt-36 pb-12 sm:pb-20 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      {/* Decorative Orbs */}
      <div className="absolute top-1/3 -left-20 w-[450px] h-[450px] bg-client-primary/5 rounded-full filter blur-[150px] pointer-events-none z-0" />
      <div className="absolute bottom-1/3 -right-20 w-[450px] h-[450px] bg-client-primary/4 rounded-full filter blur-[150px] pointer-events-none z-0" />
      ...
      <div className="absolute top-0 right-0 w-[85%] md:w-[65%] lg:w-[50%] h-[600px] lg:h-[750px] pointer-events-none z-0">
        <svg viewBox="0 0 900 600" preserveAspectRatio="none" className="w-full h-full text-client-primary" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="max-w-6xl mx-auto relative z-10 space-y-20">
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center lg:items-start justify-between gap-2 sm:gap-12 lg:gap-20 mb-8 sm:mb-16 relative -mt-4 lg:-mt-8">
          ...
          <div className="flex-1 space-y-4 lg:space-y-6 z-10 w-full max-w-xl text-center lg:text-left pt-0">
            ...
            >
              Join the <span className="text-client-primary font-semibold">PLE Team</span>
            </motion.h1>
            ...
            >
              <button 
                ...
                className="px-6 py-2.5 bg-client-primary hover:bg-client-primary-hover text-black font-bold text-xs uppercase tracking-wider rounded-lg shadow-[0_0_15px_rgba(215,25,32,0.3)] hover:-translate-y-0.5 transition-all cursor-pointer"
              >
                View Open Positions
              </button>
            </motion.div>
            ...
            >
              ...
              <div className="flex flex-wrap gap-2 justify-center lg:justify-start">
                {['Growth Opportunities', 'Flexible Work', 'Learning Culture', 'Competitive Pay', 'Team Culture'].map((benefit, i) => (
                  <span key={i} className="px-2 py-1 bg-app-card hover:bg-client-primary/10 border border-app-border/50 hover:border-client-primary/30 rounded text-[10px] font-medium text-app-text-muted hover:text-app-text transition-colors cursor-default flex items-center gap-1.5">
                    <CheckCircle2 className="w-3 h-3 text-client-primary" />
                    {benefit}
                  </span>
                ))}
              </div>
        ...
        <div id="open-positions" className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start mt-12">
              ...
              {OPEN_POSITIONS.map((job) => (
                <motion.div
                  ...
                  className={`p-6 rounded-2xl border transition-all duration-300 cursor-pointer relative overflow-hidden group flex flex-col justify-between ${
                    selectedJob === job.id
                      ? 'bg-white dark:bg-app-card border-client-primary shadow-[0_10px_30px_rgba(215,25,32,0.15)]'
                      : 'bg-white dark:bg-app-card border-slate-100 dark:border-app-border hover:border-client-primary/30 shadow-sm dark:shadow-none hover:shadow-lg dark:hover:shadow-none'
                  }`}
                >
                  {selectedJob === job.id && (
                    <div className="absolute top-0 left-0 w-1.5 h-full bg-client-primary" />
                  )}

                  <div className="space-y-4 flex-1">
                    <div className="flex flex-wrap items-start justify-between gap-2">
                      <div>
                        <span className="text-[10px] font-extrabold uppercase tracking-widest text-client-primary bg-client-primary/10 px-2.5 py-0.5 rounded border border-client-primary/20">
                          {job.department}
                        </span>
                      ...
                      <span className="text-xs font-bold text-slate-600 dark:text-app-text-muted bg-slate-50 dark:bg-white/5 border border-slate-100 dark:border-app-border px-3 py-1 rounded-full flex items-center gap-1.5">
                        <Briefcase className="w-3.5 h-3.5 text-client-primary" />
                        <span>{job.type}</span>
                      </span>
                    </div>
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-[11px] text-slate-500 dark:text-app-text-muted/80 pt-2 border-t border-slate-100 dark:border-app-border/50">
                      ...
                      <div className="flex items-center gap-1.5">
                        <Clock className="w-3.5 h-3.5 text-client-primary" />
                        <span>Experience: {job.experience}</span>
                      </div>
                    </div>
                  </div>

                  <button className="mt-6 w-full py-2 bg-client-primary/10 hover:bg-client-primary/20 text-client-primary border border-client-primary/20 rounded text-xs font-bold uppercase tracking-wider flex items-center justify-center gap-2 transition-colors">
          ...
          <motion.div 
            ...
            id="application-form"
          >
            <div className="sticky top-28 glass-panel rounded-3xl p-8 border border-client-primary/20 bg-app-card shadow-2xl space-y-8">
              
              <div className="space-y-2 border-b border-app-border pb-4 flex flex-col">
                <div className="flex items-center justify-between">
                  <span className="text-[10px] font-black uppercase tracking-widest text-client-primary block">Instant Application</span>
                  {selectedJob && (
                    <button 
                      type="button"
                      onClick={() => setValue('position', 'general')}
                      className="text-[10px] text-app-text-muted hover:text-client-primary transition-colors underline cursor-pointer"
                    >
                      Clear Selection
                    </button>
                  )}
              ...
              <AnimatePresence mode="wait">
                {!isSubmitSuccess ? (
                  ...
                  >
                    ...
                    <div className="space-y-1.5 text-left relative group">
                      <label className="text-[10px] font-bold text-black dark:text-white uppercase tracking-widest block">
                        Position Applying For <span className="text-client-primary">*</span>
                      </label>
                      <div className="relative">
                        <select
                          className={`w-full bg-transparent border-b-2 py-2 text-black dark:text-white focus:outline-none focus:border-client-primary transition-colors text-sm font-medium appearance-none cursor-pointer ${
                    ...
                    <div className="space-y-1.5 text-left relative group">
                      <label className="text-[10px] font-bold text-black dark:text-white uppercase tracking-widest block">
                        Full Name <span className="text-client-primary">*</span>
                      </label>
                      <input
                        type="text"
                        placeholder="e.g. Rahul Sharma"
                        className={`w-full bg-transparent border-b-2 py-2 text-black dark:text-white focus:outline-none focus:border-client-primary transition-colors text-sm font-medium placeholder:text-gray-500 ${
                    ...
                    <div className="space-y-1.5 text-left relative group">
                      <label className="text-[10px] font-bold text-black dark:text-white uppercase tracking-widest block">
                        Years of Experience <span className="text-client-primary">*</span>
                      </label>
                      <input
                        type="text"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-1.5 text-left relative group">
                        ...
                        <input
                          ...
                          className="w-full bg-transparent border-b-2 py-2 text-black dark:text-white focus:outline-none focus:border-client-primary transition-colors text-sm font-medium placeholder:text-gray-500 border-black/20 dark:border-white/20"
                          {...register('currentCTC')}
                        />
                      </div>
                    ...
                    <div className="space-y-1.5 text-left">
                      <label className="text-[10px] font-bold text-black dark:text-white uppercase tracking-widest block">
                        Upload Resume (PDF/DOCX) <span className="text-client-primary">*</span>
                      </label>
                      
                      <div className="relative border-2 border-dashed border-app-border hover:border-client-primary/50 bg-app-bg/50 rounded-2xl p-6 text-center transition-all group cursor-pointer">
                        <input
                          type="file"
                          accept=".pdf,.doc,.docx"
                        ...
                        <div className="space-y-2 flex flex-col items-center pointer-events-none">
                          <div className="w-10 h-10 rounded-full bg-client-primary/10 text-client-primary flex items-center justify-center group-hover:scale-110 transition-transform">
                            {fileName ? <FileText className="w-5 h-5" /> : <Upload className="w-5 h-5" />}
                          </div>
                          
                          <div className="text-xs font-bold text-app-text">
                            {fileName ? (
                              <span className="text-client-primary font-mono">{fileName}</span>
                            ) : (
                    ...
                    <div className="space-y-1.5 text-left relative group">
                      ...
                      <textarea
                        ...
                        className="w-full bg-transparent border-b-2 py-2 text-black dark:text-white focus:outline-none focus:border-client-primary transition-all resize-none text-sm font-medium placeholder:text-gray-500 border-black/20 dark:border-white/20"
                        {...register('message')}
                      />
                    </div>
                  ...
                  >
                    <div className="w-16 h-16 rounded-full bg-client-primary/10 border border-client-primary/20 text-client-primary flex items-center justify-center mx-auto shadow-[0_0_35px_rgba(215,25,32,0.25)]">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-app-text-muted leading-relaxed">
                        Thank you for applying, <strong className="text-app-text">{submittedData?.fullName}</strong>. Our engineering & HR leads will review your profile for the <strong className="text-client-primary">{submittedData?.jobTitle}</strong> position and get back to you within 48 hours.
                      </p>
                    </div>

                    <button
                      onClick={() => setIsSubmitSuccess(false)}
                      className="px-6 py-2.5 bg-client-primary/10 hover:bg-client-primary/20 border border-client-primary/30 text-client-primary hover:text-white rounded-full text-xs font-extrabold uppercase tracking-widest transition-all mx-auto flex items-center gap-1.5 cursor-pointer"
                    >
        ...
        <div className="mt-20 pt-16 border-t border-app-border/30">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold font-heading text-app-text mb-4">
              Life at <span className="text-client-primary">PLE</span>
            </h2>
          ...
          >
            ...
            >
              ...
              />
              <div className="absolute bottom-6 left-6 z-20">
                <span className="px-3 py-1 bg-client-primary text-black text-xs font-bold rounded uppercase tracking-wider mb-2 inline-block shadow-lg">Our Team</span>
            ...
            >
              ...
              />
              <div className="absolute bottom-6 left-6 z-20">
                <span className="px-3 py-1 bg-client-primary text-black text-[10px] font-bold rounded uppercase tracking-wider mb-2 inline-block shadow-lg">Growth</span>

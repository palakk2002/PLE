    ...
    <div className="bg-app-bg text-app-text-muted min-h-screen pt-24 pb-20 mesh-grid relative overflow-hidden">
      ...
      <section className="relative min-h-[25vh] flex items-center overflow-hidden mb-4">
        <div className="absolute inset-0 z-0">
          <div className="absolute -top-20 -right-20 w-[60%] h-[120%] bg-gradient-to-bl from-client-primary/10 via-client-primary/5 to-transparent rounded-bl-[100px] transform rotate-12 filter blur-2xl" />
        ...
        <div className="w-full px-4 md:px-8 relative z-10">
          ...
          >
            <div className="flex items-center justify-center gap-3 mb-4">
              <span className="px-3 py-1 bg-client-primary/10 border border-client-primary/20 text-client-primary text-[10px] font-black tracking-widest rounded-full uppercase">
                New
              </span>
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-10">
        ...
        <div className="relative w-full max-w-xl mx-auto mb-10">
          <input
            ...
            className="w-full bg-app-card/50 border border-app-border rounded-full py-3.5 pl-12 pr-6 text-app-text placeholder-app-text-muted/60 focus:outline-none focus:border-client-primary focus:ring-1 focus:ring-client-primary/20 transition-all duration-300 shadow-sm text-sm"
          />
            ...
            {dynamicCategories.map((category) => (
              <button
                ...
                className={`text-[10px] font-black tracking-[0.2em] uppercase transition-all duration-300 ${
                  ...
                  ? 'text-client-primary' 
                  : 'text-app-text hover:text-client-primary'
                }`}
              >
                {category}
              </button>
          ...
          {filteredPosts.length > 0 ? (
            ...
            <div className="py-20 text-center">
              ...
              <button 
                ...
                className="mt-6 text-client-primary font-bold hover:underline"
              >
                Clear all filters
              </button>
            </div>
        ...
        >
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-client-primary/5 rounded-full filter blur-[100px] pointer-events-none" />
          ...
          <div className="relative z-10">
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-3 max-w-lg mx-auto">
              <input
                ...
                className="w-full bg-app-bg border border-app-border rounded-lg py-3.5 px-6 text-app-text focus:outline-none focus:border-client-primary transition-all duration-300"
              />
              <button className="w-full md:w-auto bg-client-primary text-black font-black px-8 py-3.5 rounded-lg hover:bg-client-primary-hover hover:shadow-[0_0_25px_rgba(215,25,32,0.45)] transition-all duration-300 whitespace-nowrap uppercase text-[10px] tracking-widest">
                Subscribe
              </button>
            </div>
          </div>

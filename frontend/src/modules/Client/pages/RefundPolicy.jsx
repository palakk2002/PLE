  ...
  return (
    <div className="bg-white dark:bg-app-card rounded-2xl border border-slate-100 dark:border-app-border overflow-hidden shadow-sm transition-all duration-300">
      ...
      >
        ...
        <ChevronDown 
          className={`w-5 h-5 flex-shrink-0 transition-transform duration-300 ${isOpen ? 'rotate-180 text-client-primary' : 'text-slate-400 dark:text-slate-500'}`} 
        />
      </button>
    ...
    },
    {
      ...
      content: (
        <ul className="space-y-2">
          <li className="flex items-center gap-2"><span className="text-client-primary">•</span> Bank Transfer (NEFT / RTGS / IMPS)</li>
          <li className="flex items-center gap-2"><span className="text-client-primary">•</span> UPI / Payment Gateway</li>
          <li className="flex items-center gap-2"><span className="text-client-primary">•</span> International Wire Transfer (for overseas clients)</li>
        </ul>
      )
    }
  ];
      ...
      >
        ...
        <section>
          <h2 className="text-2xl font-bold font-heading text-app-text mb-6 flex items-center gap-3">
            <span className="w-3 h-3 rounded-full bg-client-primary inline-block flex-shrink-0"></span>
            1. Scope
          </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              <div key={i} className="flex items-start bg-white dark:bg-app-card px-5 py-4 rounded-xl border border-slate-100 dark:border-app-border shadow-sm">
                <span className="text-client-primary mr-3 mt-0.5 font-bold">•</span>
                <span>{item}</span>
              </div>
            ))}
          </div>
        ...
        <section>
          ...
          <div className="bg-client-primary/10 p-6 sm:p-8 rounded-2xl border border-client-primary/20 relative overflow-hidden shadow-sm">
            ...
            <ul className="space-y-4 relative z-10">
              {[
                ...
                <li key={i} className="flex items-start gap-3 text-sm">
                  <span className="text-client-primary mt-0.5 font-bold">✓</span>
                  <span>{item}</span>
                </li>
              ))}
            </ul>
            <div className="mt-6 pt-6 border-t border-client-primary/20 relative z-10">
              <p className="font-bold text-client-primary flex items-center gap-2">

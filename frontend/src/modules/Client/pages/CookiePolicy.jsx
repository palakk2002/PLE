          ...
          >
            ...
            <section>
              <h2 className="text-2xl font-bold font-heading text-app-text mb-4 flex items-center gap-2">
                <span className="w-3 h-3 rounded-full bg-client-primary inline-block"></span>
                1. What Are Cookies?
              </h2>
              <p className="mb-4">
            ...
            <section>
              ...
              <ul className="space-y-4 pl-2">
                <li className="flex items-start">
                  <span className="text-client-primary mr-3 mt-1 font-bold">•</span>
            ...
            <section>
              ...
              <div className="bg-client-primary/10 p-6 sm:p-8 rounded-2xl border border-client-primary/20 mt-8 relative overflow-hidden shadow-sm">
                <div className="absolute top-0 right-0 w-32 h-32 bg-client-primary/20 rounded-full blur-3xl -mr-16 -mt-16"></div>
                ...
                <ul className="space-y-3 relative z-10 text-sm">
                  <li className="flex items-center gap-2"><span>•</span> <a href="https://support.google.com/chrome/answer/95647" target="_blank" rel="noreferrer" className="text-client-primary hover:underline">Google Chrome</a></li>
                  <li className="flex items-center gap-2"><span>•</span> <a href="https://support.apple.com/guide/safari/manage-cookies-and-website-data-sfri11471/mac" target="_blank" rel="noreferrer" className="text-client-primary hover:underline">Apple Safari</a></li>
                  <li className="flex items-center gap-2"><span>•</span> <a href="https://support.mozilla.org/en-US/kb/enhanced-tracking-protection-firefox-desktop" target="_blank" rel="noreferrer" className="text-client-primary hover:underline">Mozilla Firefox</a></li>
                  <li className="flex items-center gap-2"><span>•</span> <a href="https://support.microsoft.com/en-us/windows/microsoft-edge-browsing-data-and-privacy-bb8174ba-9d73-dcf2-9b4a-c582b4e640dd" target="_blank" rel="noreferrer" className="text-client-primary hover:underline">Microsoft Edge</a></li>
                </ul>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="bg-white dark:bg-app-card p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-app-border space-y-4">
                <div className="flex items-center gap-4">
                  <div className="w-10 h-10 rounded-full bg-client-primary/10 flex items-center justify-center text-client-primary font-bold">@</div>
                  <div>
                    <p className="text-sm text-slate-500 dark:text-slate-400">Email Address</p>
                    <a href="mailto:support@ple.in" className="text-app-text font-semibold hover:text-client-primary transition-colors">support@ple.in</a>
                  </div>
                </div>

    ...
    <section className="py-6 sm:py-10 px-4 sm:px-6 lg:px-8 bg-app-bg relative overflow-hidden">
      <div className="max-w-7xl mx-auto relative z-10">
        <motion.div
          ...
          className="relative overflow-hidden rounded-[2.5rem] bg-client-primary p-8 sm:p-12 md:p-14 text-center lg:text-left shadow-2xl shadow-client-primary/20 border border-white/10"
        >

...
export default function StatsCounter() {
  ...
  return (
    <section className="py-8 px-4 relative z-10">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[250px] bg-client-primary/5 blur-[100px] pointer-events-none rounded-full" />
          ...
          {stats.map((stat, index) => {
            ...
            return (
              ...
              >
                ...
                {/* Icon Box */}
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-lg sm:rounded-xl bg-client-primary/10 border border-client-primary/20 flex items-center justify-center text-client-primary group-hover:scale-110 group-hover:bg-client-primary group-hover:text-black transition-all duration-300 shrink-0 shadow-[0_0_15px_rgba(215,25,32,0.15)] relative z-10">
                  <IconComponent className="w-4 h-4 sm:w-5 sm:h-5" />
                </div>

                {/* Text & Counter */}
                <div className="space-y-0.5 sm:space-y-1 relative z-10">
                  <div className="text-lg sm:text-2xl md:text-3xl font-bold font-heading text-client-primary transition-colors flex items-center justify-center sm:justify-start tracking-tight">

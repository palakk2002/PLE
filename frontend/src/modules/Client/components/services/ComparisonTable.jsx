...
export default function ComparisonTable() {
  return (
    <section className="mb-24">
      ...
      >
        <h2 className="text-2xl md:text-3xl font-bold font-heading tracking-tight">Why Choose <span className="text-client-primary">PLE</span>?</h2>
        ...
        <table className="w-full text-left border-collapse min-w-[600px]">
          <thead>
            <tr className="border-b border-white/10">
              ...
              <th className="py-4 px-6 bg-client-primary/5 text-client-primary text-sm font-bold tracking-wide rounded-t-xl border-x border-t border-client-primary/20 text-center w-1/3">PLE</th>
          ...
          <tbody>
            {comparisonData.map((row, i) => (
              <tr key={i} className="border-b border-white/5 hover:bg-white/[0.02] transition-colors">
                ...
                <td className="py-4 px-6 bg-client-primary/[0.02] border-x border-client-primary/20 text-center relative group">
                  <div className="flex items-center justify-center gap-2">
                    <Check className="w-4 h-4 text-client-primary shrink-0" />
                    <span className="text-[13px] font-bold text-white group-hover:text-client-primary transition-colors">{row.vedhunt}</span>
                  </div>
                </td>
          ...
          <tfoot>
            <tr>
              ...
              <td className="py-2 px-6 bg-client-primary/5 border-x border-b border-client-primary/20 rounded-b-xl"></td>
              <td className="py-2 px-6"></td>
            </tr>
          </tfoot>
        </table>

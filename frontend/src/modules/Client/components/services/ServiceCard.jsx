...
export default function ServiceCard({ service, image }) {
  ...
  return (
    <motion.div
      className="group relative bg-app-card rounded-2xl border border-app-border hover:border-client-primary transition-all duration-300 shadow-md hover:shadow-xl flex flex-col h-full overflow-hidden"
    >
      ...
      <div className="relative z-10 p-5 flex flex-col flex-grow">
        ...
        <Link
          to={`/service/${slug}`}
          className="inline-flex items-center gap-2 text-[11px] font-black text-client-primary uppercase tracking-wider group/link"
        >

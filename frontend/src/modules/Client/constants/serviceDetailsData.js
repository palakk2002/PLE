...
export const SERVICE_DETAILS_DATA = {
  'website-development': {
    ...
    pricing: {
      type: 'project',
      toggleLabels: { 'client-primary': 'One-Time Payment', secondary: 'With Annual Support' },
      plans: [
        {
          title: 'Starter',
          priceOneTime: '₹14,999',
  ...
  'mobile-app-development': {
    ...
    pricing: {
      type: 'project',
      toggleLabels: { 'client-primary': 'MVP Release', secondary: 'Production Ready' },
      plans: [
        {
          title: 'Starter MVP',
          priceOneTime: '₹49,999',
  ...
  'social-media-management': {
    ...
    pricing: {
      type: 'monthly',
      toggleLabels: { 'client-primary': 'Standard Retainer', secondary: 'Quarterly Package (Save 15%)' },
      plans: [
        {
          title: 'Starter',
  ...
  'performance-marketing': {
    ...
    pricing: {
      type: 'monthly',
      toggleLabels: { 'client-primary': 'Standard Retainer', secondary: 'Quarterly Setup (Save 15%)' },
      plans: [
        {
  ...
  'accounting-financial-services': {
    ...
    pricing: {
      type: 'monthly',
      toggleLabels: { 'client-primary': 'Monthly Retainer', secondary: 'With Quarterly Audit' },
      plans: [
        {
  ...
  'mis-reporting-services': {
    ...
    pricing: {
      type: 'project',
      toggleLabels: { 'client-primary': 'Dashboard Build', secondary: 'With Monthly SLA Support' },
      plans: [
        {

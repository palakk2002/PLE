...
import { FiUser, FiMail, FiPhone, FiLock, FiEye, FiEyeOff, FiSave, FiCamera, FiArrowLeft, FiPackage, FiMapPin, FiLogOut, FiChevronRight, FiBell, FiBriefcase, FiTrendingUp } from 'react-icons/fi';
                ...
                {!isDesktop && activeTab === 'menu' && (
                  ...
                  >
                    ...
                    <div className="glass-card rounded-2xl p-6 flex flex-col items-center text-center shadow-sm">
                      ...
                      <p className="text-gray-500 text-sm mb-2 font-medium">{user?.email}</p>
                    ...
                    <div className="pt-2">
                      <button
                        onClick={() => {
                          const nextRole = isBusiness ? 'customer' : 'business_buyer';
                          setUserRole(nextRole);
                          toast.success(`Switched to ${nextRole === 'business_buyer' ? 'Business (B2B)' : 'Individual (B2C)'} mode!`);
                        }}
                      ...
                      >
                        ...
                        <span>Switch to {isBusiness ? 'Individual (B2C)' : 'Business (B2B)'} Mode</span>
                      </button>
                    </div>

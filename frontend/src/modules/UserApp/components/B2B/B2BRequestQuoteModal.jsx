...
import { FiX, FiCheckCircle, FiSend, FiFileText } from 'react-icons/fi';
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-4">
            ...
            <div>
              ...
              <div className="bg-gray-50 p-2.5 rounded-xl border border-gray-100 text-xs text-gray-600 space-y-0.5">
                <p>
                  <span className="font-bold">Company:</span> {businessProfile.companyName}
                </p>
                <p>
                  <span className="font-bold">GSTIN:</span> {businessProfile.gstNumber}
                </p>
                <p>
                  <span className="font-bold">Email:</span> {businessProfile.businessEmail}
                </p>
              </div>
            </div>

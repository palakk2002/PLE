...
export const products = [
  ...
  },
  {
    ...
    image: stylishWatchImg,
    images: [stylishWatchImg, stylishWatchImg],
    flashSale: false,
    stock: "in_stock",
    stockQuantity: 5,
    rating: 4.6,
    ...
    refurbishedGrade: "A",
    refurbishedWarrantyDuration: "12 months",
    refurbishedUsedDuration: "1 year",
    refurbishedBatteryHealth: 94,
    refurbishedCosmeticNotes: "Excellent condition watch, minor strap wear. Glass is scratch-free.",
    refurbishedAccessories: ["Charger", "Original Box", "Quality Certificate"],
    refurbishedCertified: true,
    refurbishedTestingPassed: true,
  },
  {
    id: "refurb_2",
    ...
    condition: "renewed",
    refurbishedGrade: "A",
    refurbishedWarrantyDuration: "6 months",
    refurbishedUsedDuration: "6 months",
    refurbishedCosmeticNotes: "Excellent leather conditioning. Light scuff marks on sole, upper looks brand new.",
    refurbishedAccessories: ["Shoe Box", "Care Tag"],
    refurbishedCertified: true,
    refurbishedTestingPassed: true,
  },
  {
    id: "refurb_3",
    name: "Puma Open-Box Athletic Running Shoes",
    unit: "Pair",
    price: 54.99,
    originalPrice: 94.99,
    image: sneakersImg,
    ...
    condition: "open_box",
    refurbishedGrade: "A",
    refurbishedWarrantyDuration: "3 months",
    refurbishedUsedDuration: "2 weeks",
    refurbishedCosmeticNotes: "Slight packaging damage, product itself is in pristine, brand-new condition.",
    refurbishedAccessories: ["Original Tags", "Puma Box"],
    refurbishedCertified: false,
    refurbishedTestingPassed: true,
  },
  {
    id: "refurb_4",
    name: "Levi's Refurbished Slim Fit Denim Jacket",
    unit: "Piece",
    price: 39.99,
    originalPrice: 79.99,
    image: denimJacketImg,
    ...
    refurbishedGrade: "B",
    refurbishedWarrantyDuration: "3 months",
    refurbishedUsedDuration: "1.5 years",
    refurbishedCosmeticNotes: "Minor cosmetic wear on cuffs and collar. Buttons are all secure.",
    refurbishedAccessories: ["Product Tag"],
    refurbishedCertified: true,
    refurbishedTestingPassed: true,
  },
];
